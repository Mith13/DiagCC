...
const int Vertex::getTimePosition() const
{
    ...
    else return(aux::abortMessage("Time position was not setted"));
}
...
const int Vertex::getIndex() const
{
    ...
    else return(aux::abortMessage("Index was not setted"));
}
...
void VertexPool::getTimedEquivalentVertices(std::vector<std::vector<int>>& equivalent_vertices,const int t_pos,const int up_lines,const int down_lines)const
{
	std::vector<int> equal_vertices;
    for(auto& v : vertices)
    {
